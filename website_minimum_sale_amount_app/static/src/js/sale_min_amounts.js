odoo.define('website_minimum_sale_amount_app.sale_min_amounts', function (require) {
'use strict';
    	...
    	_onchangepricetarget: function () {
			setTimeout(function(){ 
				...
				if (amount_totals >= prices){
	                $(".checkout-button").attr('style', 'display:none')
	                $(".warning-grater-value").hide()
	            }
	            else {
	                $(".checkout-button").attr('style', 'display:none !important')
